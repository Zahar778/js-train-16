...
function filterStudentsByGrade(students, grade) {
  console.clear();
  console.warn("Якщо ви бачите це повідомлення, то завдання 1 виконано не правильно");
...
function logArrayElements(arr) {
  if(!Array.isArray(arr)) {
    return "Аргумент має бути масивом!", null;
  }
  let arrayElements = []
...
function warnAboutMaxArrayLength(arr, maxLength) {
  if(!Array.isArray(arr) && typeof maxLength === "number") {
    return "Перший аргумент має бути масивом, другий аргумент має бути числом!", null;
  }
...
function displayGroupedInfo(students) {
  for( const student of students) {
    ...
    console.info(`Студент: ${student.age}`)
    console.info(`Студент: ${student.subject}`)
    console.groupEnd()
  }
...
function validateUserInput(userInput) {
  if(userInput.username === undefined) {
    ...
    console.log("Все працює. Ви красавчик!");
...
function countVowelsAndConsonants(word) {
  ...
  for (const letter of word) {
    ...
    if (vowels.includes(lowercaseLetter)) {
      vowelsCount++;
    } else if (/[a-zA-Z]/.test(lowercaseLetter)) {
      consonantsCount++;
    }
  }
